...
<script lang="ts" setup>
    ...
    const clickCard = (item) => {
        ...
        cardItemList.value = cardItemList.value
            .slice(0, index)
            .concat(cardItemList.value.slice(index + 1))
        calcCover()
        ...
        penddingList.value.some((item) => {
            if (calcValueList[item.val] === 3) {
                ...
                penddingList.value.forEach((b, index) => {
                    b.style.top = '160%'
                    b.style.left =
                        leftOffset.value + index * CardItem.width * 2 + 'px'
                })
...
<style scoped lang="scss">
    ...
    .card-item {
        ...
        cursor: pointer;
        transition: all 0.3s;
        box-shadow: 0 3px 0 0 #fff, 0 8px 0 0 #ddd, 0 8px 0 2px #333,
            0 0 0 2px #333;
    }
    ...
    .item-cover {
        pointer-events: none;
        box-shadow: 0 3px 0 0 #999, 0 8px 0 0 #666, 0 8px 0 2px #000,
            0 0 0 2px #000;
    }
