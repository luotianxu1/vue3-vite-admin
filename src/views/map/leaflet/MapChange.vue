<template>
	<div style="width: 100%; height: 100%">
		<div class="btn">
			<el-button type="primary" @click="changeBaseMapLayer('GaoNormal')"> 高德地图 </el-button>
			<el-button type="primary" @click="changeBaseMapLayer('GaoDeImage')"> 高德卫星 </el-button>
			<el-button type="primary" @click="changeBaseMapLayer('TianNormal')"> 天地图 </el-button>
			<el-button type="primary" @click="changeBaseMapLayer('TianImage')"> 天地图卫星 </el-button>
			<el-button type="primary" @click="changeBaseMapLayer('OSM')"> OSM </el-button>
			<el-button type="primary" @click="changeBaseMapLayer('Tencent')"> 腾讯地图 </el-button>
			<el-button type="primary" @click="changeBaseMapLayer('Baidu')"> 百度地图 </el-button>
		</div>
		<div id="map"></div>
	</div>
</template>
...
const initMap = () => {
	...
	baseLayer = L.tileLayer.chinaProvider("Tencent.Normal.Map", { maxZoom: 18, minZoom: 5 }).addTo(map)
