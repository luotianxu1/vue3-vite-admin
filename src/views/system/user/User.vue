	...
	<LayoutQuery :loading="tableData.loading">
		<template #fl>
			<div class="query-item">
				<el-input v-model="queryParams.name" placeholder="请输入用户姓名" clearable></el-input>
			</div>
			<div class="query-item">
		...
		<template #table>
			...
			>
				<template #operation="row">
					<el-button type="info" :icon="Edit" circle @click="deleteInfo(row.data.id)"></el-button>
				...
				<template #status="row">
					<el-switch v-model="row.data.status" :active-value="1" inline-prompt active-text="启" inactive-text="禁"></el-switch>
				</template>
			</MyTable>
		</template>
		<template #btn>
