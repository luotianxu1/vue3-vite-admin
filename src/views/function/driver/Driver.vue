	...
	<LayoutQuery :loading="tableData.loading" @click.prevent.stop="handleGuid1">
		<template #fl>
			<div id="user-input" class="query-item">
				<el-input v-model="tableData.name" placeholder="请输入用户姓名" clearable></el-input>
			</div>
			<div id="role-input" class="query-item">
				<el-select v-model="tableData.type" placeholder="请选择用户角色" clearable>
			...
			<div class="query-item">
				<el-button id="search" :icon="Search" type="primary"> 查询 </el-button>
			</div>
		</template>
		<template #fr>
			<div class="query-item">
		...
		<template #table>
			<el-table ref="table" :data="tableData.data" stripe border highlight-current-row empty-text="暂无数据" height="100%">
				<template #empty>
				...
				<el-table-column prop="name" align="center" label="头像" width="80">
				...
				<el-table-column prop="type" align="center" label="角色" width="100">
					<template #default="scope">
						<el-tag v-if="scope.row.type === 0" type="danger"> 超级管理员 </el-tag>
						<el-tag v-if="scope.row.type === 1" type="warning"> 管理员 </el-tag>
						<el-tag v-if="scope.row.type === 2" type="success"> 用户 </el-tag>
					</template>
				</el-table-column>
				<el-table-column prop="phone" align="center" label="手机号" width="150" />
				<el-table-column prop="email" align="center" label="邮箱" />
				<el-table-column prop="city" align="center" label="城市" />
				<el-table-column prop="status" align="center" label="状态" width="70">
					<template #default="scope">
						<el-switch
				...
				<el-table-column prop="add_time" align="center" label="添加时间" width="120" />
				<el-table-column prop="edit_time" align="center" label="修改时间" width="120" />
				<el-table-column prop="id" align="center" fixed="right" label="操作" width="180">
					<template #default>
