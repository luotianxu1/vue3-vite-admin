...
export default defineComponent({
	...
	setup(props, ctx) {
		...
		const onmousemove = e => {
			...
			let { startX, startY, startWidth, startHeight, startLeft, startTop, direction } = data as any
			...
			blockData.value.width = startWidth + durX
			blockData.value.height = startHeight + durY
