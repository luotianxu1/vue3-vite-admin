			...
			<div class="form-item">
				<el-form :model="form" label-width="100px">
					<el-form-item label="cubePosX">
						<el-slider v-model="form.cubePosX" :min="-20" :max="20" :step="1" />
					</el-form-item>
					<el-form-item label="cubePosY">
						<el-slider v-model="form.cubePosY" :min="-20" :max="20" :step="1" />
					</el-form-item>
					<el-form-item label="cubePosZ">
						<el-slider v-model="form.cubePosZ" :min="-20" :max="20" :step="1" />
					</el-form-item>
					<el-form-item label="spherePosX">
						<el-slider v-model="form.spherePosX" :min="-20" :max="20" :step="1" />
					</el-form-item>
					<el-form-item label="spherePosY">
						<el-slider v-model="form.spherePosY" :min="-20" :max="20" :step="1" />
					</el-form-item>
					<el-form-item label="spherePosZ">
						<el-slider v-model="form.spherePosZ" :min="-20" :max="20" :step="1" />
					</el-form-item>
					<el-form-item label="groupPosX">
						<el-slider v-model="form.groupPosX" :min="-20" :max="20" :step="1" />
					</el-form-item>
					<el-form-item label="groupPosY">
						<el-slider v-model="form.groupPosY" :min="-20" :max="20" :step="1" />
					</el-form-item>
					<el-form-item label="groupPosZ">
						<el-slider v-model="form.groupPosZ" :min="-20" :max="20" :step="1" />
					</el-form-item>
...
import { initAxes, initCamera, initCameraControl, initDefaultLighting, initLargeGroundPlane, initStats } from "@/utils/three/util"
