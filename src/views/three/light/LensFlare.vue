...
const textureFlare0 = THREE.ImageUtils.loadTexture("../../src/assets/img/three/flares/lensflare0.png")
const textureFlare3 = THREE.ImageUtils.loadTexture("../../src/assets/img/three/flares/lensflare3.png")
