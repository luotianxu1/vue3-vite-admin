...
const init = () => {
	...
	// 加载点材质纹理
	const starsTexture = new THREE.TextureLoader().load("./textures/earth/stars.png")
	...
	let earthTexture = new THREE.TextureLoader().load("./textures/earth/map.jpg")
	...
	// 内发光
	let spriteTexture1 = new THREE.TextureLoader().load("./textures/earth/innerGlow.png")
	...
	for (let i = 0; i < 30; i++) {
		// 实现光柱
		let lightPillarTexture = new THREE.TextureLoader().load("./textures/earth/light_column.png")
		...
		let circleTexture = new THREE.TextureLoader().load("./textures/earth/label.png")
	...
	// 创建月球环
	let moonRingTexture = new THREE.TextureLoader().load("./textures/earth/moon_ring.png")
