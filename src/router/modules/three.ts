...
const systemRouter: RouteRecordRaw[] = [
	{
		...
		children: [
			...
			},
			{
				...
				name: "车",
				meta: { title: "car" },
				component: () => import("@/views/three/demo/car/Car.vue")
			},
			{
				path: "fireWork",
				name: "烟花",
			...
			},
			{
				...
				name: "地球",
				meta: { title: "earch" },
				component: () => import("@/views/three/demo/earch/Earch.vue")
			},
			{
				path: "robot",
				name: "机器人",
				meta: { title: "robot" },
				component: () => import("@/views/three/demo/robot/Robot.vue")
			},
			{
				path: "physics1",
				name: "小球下落",
			...
			// },
			{
				...
				component: () => import("@/views/three/shader/rawShaderMaterial/RawShadermaterial.vue")
			},
			{
				path: "deep",
				name: "着色器",
